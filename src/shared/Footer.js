          ...
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <div>
              ...
              <div class="flex flex-col items-start mt-5 space-y-2">
                ...
                <Link
                  to="/"
                  class="text-gray-600 transition-colors duration-300 dark:text-gray-700 dark:hover:text-blue-400 hover:underline hover:text-blue-500"
                >
                  Who We Are
                </Link>
                <Link
          ...
          <div class="flex flex-col items-center justify-between sm:flex-row">
            <Link to="/">
              <div className="flex">
                ...
                <h1 className="text-2xl ml-3  font-bold tracking-wide text-gray-800 uppercase">
                  {" "}
                  Marker key.Io
                </h1>
              </div>
            ...
            <p class="mt-4 text-sm text-gray-500 sm:mt-0 dark:text-gray-700">
