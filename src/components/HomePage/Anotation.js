      ...
      <section class=" bg-gray-900 dark:bg-white">
        <div class="container px-6 py-10 mx-auto">
          <h1 class="text-2xl font-semibold text-gray-100 capitalize lg:text-3xl dark:text-gray-800">
            IMAGE AND
            <br /> VIDEO <span class="text-blue-500"> ANNOTATION</span>
          </h1>

          {/* <iframe
           
            src="https://youtu.be/3HIDpZ_aS2s"
            frameborder="0"
          ...
          <iframe
            ...
            src="https://www.youtube.com/embed/3HIDpZ_aS2s"
              ...
              <div class="md:flex md:items-start md:-mx-4">
                ...
                <div class="mt-4 md:mx-4 md:mt-0">
                  ...
                  <p class="mt-3 text-gray-500 dark:text-gray-600">
                    ...
                    professional in-house annotation team ensure the best
                    results for your computer vision training data needs.
                    Annotating videos while tracking objects through multiple
                    frames. Each object on the video will be recognized and
                    tracked even through different cameras or separate video
                    segments.
                  </p>
                </div>
              </div>
