      ...
      <section class="bg-gray-900 dark:bg-white">
        <div class="container px-6 py-10 mx-auto">
          <h1
           ...
           capitalize lg:text-3xl dark:text-gray-800"
          >
            Our Executive Team
          </h1>

          <p class="max-w-2xl mx-auto my-6 text-center text-gray-500 dark:text-gray-700">
            Meet Some of Our Talented Team member who is contioniously Develop
            AI faster and better with on-premise, enterprise-grade end-to-end
            solution for every task: from labeling to building production
            models.
          </p>
          ...
          <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-600 rounded-xl">
              ...
              <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-gray-800 group-hover:text-white">
                arthur melo
              </h1>

              <p class="mt-2 text-gray-500 capitalize dark:text-gray-700 group-hover:text-gray-300">
                design director
              </p>
              ...
              <div class="flex mt-3 -mx-2">
                <Link
                  to="/"
                  class="mx-2 text-gray-600 dark:text-gray-700 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"
                  aria-label="Reddit"
                >
                  <svg
