  ...
  return (
    <div>
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        ...
        >
          OUR
          <br /> All <span class="text-blue-500"> SERVICES</span>
        </h1>
        <div className="grid max-w-screen-lg gap-8 row-gap-5 md:row-gap-8 sm:mx-auto lg:grid-cols-2">
          ...
          <div className="transition duration-300 transform bg-white rounded shadow-sm hover:-translate-y-1 hover:shadow md:text-center">
            ...
            <div className="px-6 py-8 border border-t-0 rounded-b sm:px-8">
              ...
              <p className="mb-5 text-gray-700">
                At Marker Key.Io we are conscientious about collecting data from
                reputable and legal sources. We exclusively use open source data
                to ensure the highest quality and transparency for our clients.
              </p>
              <button
                type="submit"
          ...
          <div className="transition duration-300 transform bg-white rounded shadow-sm hover:-translate-y-1 hover:shadow md:text-center">
            ...
            <div className="px-6 py-8 border border-t-0 rounded-b sm:px-8">
              ...
              <p className="mb-5 text-gray-700">
                We assign objects to different classes in images or videos, and
                help to train machine learning models to recognize objects in
                any context.transformative technology by creating image and
