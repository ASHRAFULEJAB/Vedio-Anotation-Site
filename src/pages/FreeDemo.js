...
import img from "../asstes/images/trail.avif";
          ...
          <div class="container flex flex-col flex-1 px-6 py-12 mx-auto">
            <div class="flex-1 lg:flex lg:items-center lg:-mx-6">
              <div class="text-white lg:w-1/2 lg:mx-6">
                ...
                <button
                  class="px-8 py-3 mt-6 text-sm font-bold tracking-wide
                 text-white capitalize transition-colors duration-300 transform
                  bg-sky-500 rounded-md hover:bg-sky-600 focus:outline-none focus:ring
              ...
              <div class="mt-8 lg:w-1/2 lg:mx-6">
                <div class="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                  ...
                  <form class="mt-6">
                    ...
                    <button
                      class="w-full px-6 py-3 mt-6 text-sm font-bold tracking-wide
                     text-white capitalize transition-colors duration-300 transform
                      bg-sky-500 rounded-md hover:bg-sky-600 focus:outline-none focus:ring
                       focus:ring-blue-400 focus:ring-opacity-50"
                    >
